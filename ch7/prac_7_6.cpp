...
int main(int argc, char** argv)
{
	if (argc != 5)
	{
		cout << "usage: prac_7_6 img1 img2 depth1 depth2" << endl;
		return 1;
	}
	...
	solvePnP(pts_3d, pts_2d_2, K, Mat(), r, t, false); // 调用OpenCV的Pnp求解，可选择EPNP，DLS等方法
	Mat R;
...
)
{
	...
	/*********************add vertex*********************/
	// vertex 1
	g2o::VertexSE3Expmap* pose_1 = new g2o::VertexSE3Expmap(); // camera pose 1
	pose_1->setId(0);
	...
	// vertex 2
	g2o::VertexSE3Expmap* pose_2 = new g2o::VertexSE3Expmap(); // camera pose 2
	...
	pose_2->setId(1);
	pose_2->setEstimate(g2o::SE3Quat(
				R_mat,
				Eigen::Vector3d(t.at<double>(0, 0), t.at<double>(1, 0), t.at<double>(2, 0))
			));
	optimizer.addVertex(pose_2);
	...
	cout << "T1=" << endl << Eigen::Isometry3d(pose_1->estimate()).matrix() << endl;
	cout << "T2=" << endl << Eigen::Isometry3d(pose_2->estimate()).matrix() << endl;
}
