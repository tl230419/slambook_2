...
// g2o edge
class EdgeProjectXYZRGBDPoseOnly : public g2o::BaseUnaryEdge<3, Eigen::Vector3d, camera_vertex>
{
public:
	EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
	...
	{
		const camera_vertex* pose = static_cast<const camera_vertex*>(_vertices[0]);
	...
	{
		camera_vertex* pose = static_cast<camera_vertex*>(_vertices[0]);
...
)
{
	...
	for (size_t i = 0; i < pts1.size(); i++)
	{
		...
		edge->setId(index);
		edge->setVertex(0, dynamic_cast<camera_vertex*>(pose));
