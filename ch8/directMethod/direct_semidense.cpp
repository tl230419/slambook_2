...
// proejct a 3d point into an image plane, the error is photometric error
...
public:
	...
	virtual void linearizeOplus()
	{
		...
		// NOTE that in g2o the Lie algebra is (\omega, \epsilon), where \omega is so(3) and \esilon the translation
	...
	// dummy read and write function because we don't care...
...
int main(int argc, char** argv)
{
	...
	for (int index = 0; index < 10; index++)
	{
		...
		for (Measurement m:measurements)
		{
			...
			img_show.ptr<uchar>(pixel_now(1, 0))[int(pixel_now(0, 0))*3] = b;
			img_show.ptr<uchar>(pixel_now(1, 0))[int(pixel_now(0, 0))*3+1] = g;
			img_show.ptr<uchar>(pixel_now(1, 0))[int(pixel_now(0, 0))*3+2] = r;
