...
public:
	...
	// dumy read and write functions because we don't care...
...
bool poseEstimationDirect(const vector<Measurement>& measurements, cv::Mat* gray, Eigen::Matrix3f& K, Eigen::Isometry3d& Tcw)
{
	...
	// g2o::OptimizationAlgorithmGaussianNewton* solver = new g2o::OptimizationAlgorithmGaussianNewton(solver_ptr); // G-N
